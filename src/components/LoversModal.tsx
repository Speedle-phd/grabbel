...
const LoversModal = ({setValue, close} : LoversModalProps) => {
   ...
   return (
      <>
         ...
         <form onSubmit={submitHandler} className="flex flex-col items-center gap-4" method="POST">
            <h2 className="text-xl font-bold text-pretty text-center">Gib hier die Namen der Grabbler ein:</h2>
            <Underline />
            <div className='form-control grid'>
               <label htmlFor='name1'>Grabbelherausforderer 1</label>
               <input ref={name1Ref} className="border-2 rounded-sm px-4 py-2" type='text' id='name1' name='name1' />
            </div>
            <div className='form-control grid'>
               <label htmlFor='name2'>Grabbelherausforderer 2</label>
               <input ref={name2Ref} className="border-2 rounded-sm px-4 py-2" type='text' id='name2' name='name2' />
            </div>
            <input className="
